...
public class Permissions implements PermissionsListener {


    private Activity activity;
    private PermissionObj permisosObj;

    public Permissions(Activity activity, PermissionObj permisosObj) {
